...
{
FILE*f;
f=fopen("/home/dhia/Projects/project3/src/users.txt","a+");
if(f!=NULL)
...
{ 	
	...
	tmp=fopen("/home/dhia/Projects/project3/src/users.tmp","a+");
...
fclose(f);
fclose(tmp);
rename("/home/dhia/Projects/project3/src/users.tmp","/home/dhia/Projects/project3/src/users.txt");
}
...
rename("/home/dhia/Projects/project3/src/users.tmp","/home/dhia/Projects/project3/src/users.txt");
	...
	tmp1=fopen("/home/dhia/Projects/project3/src/profiles.tmp","w");
...
fclose(f1);
fclose(tmp1);
rename("/home/dhia/Projects/project3/src/profiles.tmp","/home/dhia/Projects/project3/src/profiles.txt");
}
...
FILE *f1;
f1=fopen("/home/dhia/Projects/project3/src/users.txt","r");
if(f1!=NULL){
...
{
FILE*f;
f=fopen("/home/dhia/Projects/project3/src/event.txt","a+");
if(f!=NULL)
...
FILE *f1;
f1=fopen("/home/dhia/Projects/project3/src/event.txt","r");
if(f1!=NULL){
...
int journ,moisn,anneen;
	FILE *f , *tmp;
	f=fopen("/home/dhia/Projects/project3/src/event.txt","r");
	tmp=fopen("/home/dhia/Projects/project3/src/event.tmp","a+");
...
fclose(f);
fclose(tmp);
rename("/home/dhia/Projects/project3/src/event.tmp","/home/dhia/Projects/project3/src/event.txt");
}                  
...
f=fopen("/home/dhia/Projects/project3/src/profiles.txt","r");
